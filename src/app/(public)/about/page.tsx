        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-16 lg:gap-24 items-start lg:grid-cols-5">
            ...
            <div className="relative lg:col-span-2">
              <div className="relative aspect-[3/4] overflow-hidden">
                {settings.about_image ? (
                  ...
                  <div className="h-full w-full bg-gradient-to-br from-[#E7E0D8] via-[#F5F0EB] to-[#E7E0D8] flex items-center justify-center">
                    <span className="font-playfair text-3xl italic text-[#B8977E]/30">Portrait</span>
                  </div>
                )}
              </div>
              {/* Decorative accent */}
              <div className="absolute -bottom-4 -right-4 w-full h-full border border-[#B8977E]/20 -z-10" />
            </div>
            ...
            <div className="lg:col-span-3 lg:pt-8">
              ...
              <h2 className="font-playfair text-3xl md:text-4xl text-[#1C1917] mb-10">
                Dedicated to the Art of Beauty
              </h2>
              <div className="space-y-6">
                {(settings.about_bio || "Welcome to my portfolio.").split("\n").filter(Boolean).map((paragraph, i) => (
                  <p key={i} className="text-[15px] leading-[1.8] text-[#78716C]">
                    {paragraph}
                  </p>
                ))}
              </div>
              ...
              {/* Stats */}
              <div className="mt-14 pt-10 border-t border-[#E7E0D8] grid grid-cols-3 gap-8">
                {[
                  ...
                  <div key={stat.label}>
                    <p className="font-playfair text-3xl text-[#B8977E]">{stat.value}</p>
                    <p className="mt-1 text-[10px] font-medium uppercase tracking-[0.15em] text-[#A8A29E]">
                      {stat.label}
                    </p>
                  </div>
                ))}
